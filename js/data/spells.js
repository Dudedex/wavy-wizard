...
const SPELLS = {
  missile: {
    ...
    tiers: [
      { dmg: 25, cd: 0.51, range: 420, price: 14 },
      { dmg: 34, cd: 0.58, range: 450, price: 34 },
      { dmg: 48, cd: 0.51, range: 480, price: 68 },
      { dmg: 70, cd: 0.45, range: 520, price: 120 },
    ],
  ...
  fireball: {
    ...
    tiers: [
      { dmg: 19, cd: 1.20, range: 420, radius: 70,  price: 18 },
      { dmg: 25, cd: 0.72, range: 440, radius: 82,  price: 42 },
      { dmg: 42, cd: 1.02, range: 470, radius: 96,  price: 85 },
      { dmg: 68, cd: 0.72, range: 500, radius: 112, price: 150 },
    ],
  ...
  frost: {
    ...
    tiers: [
      { dmg: 10, cd: 0.72, range: 460, pierce: 3, slow: 0.35, price: 16 },
      { dmg: 13, cd: 0.51, range: 480, pierce: 4, slow: 0.40, price: 38 },
      { dmg: 21, cd: 0.56, range: 500, pierce: 6, slow: 0.45, price: 75 },
      { dmg: 34, cd: 0.48, range: 540, pierce: 9, slow: 0.50, price: 130 },
    ],
  ...
  firebreath: {
    ...
    tiers: [
      ...
      { dmg: 60, cd: 0.84, range: 250, price: 160 },
    ],
  ...
  earthbreath: {
    ...
    tiers: [
      { dmg: 15, cd: 1.20, range: 200, price: 20 },
      { dmg: 23, cd: 0.72, range: 215, price: 46 },
      { dmg: 36, cd: 1.02, range: 230, price: 90 },
      { dmg: 56, cd: 0.92, range: 250, price: 160 },
    ],
  ...
  windbreath: {
    ...
    tiers: [
      ...
      { dmg: 21, cd: 1.20, range: 215, price: 46 },
