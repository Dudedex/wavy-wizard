...
const SPELLS = {
  missile: {
    ...
    tiers: [
      { dmg: 25, cd: 0.51, range: 546, price: 14 },
      { dmg: 34, cd: 0.58, range: 585, price: 34 },
      { dmg: 48, cd: 0.51, range: 624, price: 68 },
      { dmg: 70, cd: 0.45, range: 676, price: 120 },
    ],
  ...
  fireball: {
    ...
    tiers: [
      { dmg: 19, cd: 1.20, range: 546, radius: 70,  price: 18 },
      { dmg: 25, cd: 0.72, range: 572, radius: 82,  price: 42 },
      { dmg: 42, cd: 1.02, range: 611, radius: 96,  price: 85 },
      { dmg: 68, cd: 0.72, range: 650, radius: 112, price: 150 },
    ],
  ...
  frost: {
    ...
    tiers: [
      { dmg: 10, cd: 0.72, range: 598, pierce: 3, slow: 0.35, price: 16 },
      { dmg: 13, cd: 0.51, range: 624, pierce: 4, slow: 0.40, price: 38 },
      { dmg: 21, cd: 0.56, range: 650, pierce: 6, slow: 0.45, price: 75 },
      { dmg: 34, cd: 0.48, range: 702, pierce: 9, slow: 0.50, price: 130 },
    ],
  ...
  lightning: {
    ...
    tiers: [
      { dmg: 7, cd: 0.92, range: 380, chains: 3, price: 20 },
      { dmg: 9, cd: 0.84, range: 400, chains: 4, price: 46 },
      { dmg: 12, cd: 0.76, range: 430, chains: 5, price: 90 },
      { dmg: 16, cd: 0.68, range: 460, chains: 7, price: 160 },
    ],
  ...
  shield: {
    ...
    tiers: [
      { shield: 16, cd: 4.8, price: 16 },
      { shield: 20, cd: 2.8, price: 40 },
      { shield: 32, cd: 3.2, price: 80 },
      { shield: 50, cd: 2.8, price: 140 },
    ],
  ...
  poison: {
    ...
    tiers: [
      { dps: 8,  cd: 2.8, range: 480, radius: 70,  dur: 3.5, price: 15 },
      { dps: 11, cd: 2.6, range: 500, radius: 82,  dur: 4.0, price: 36 },
      { dps: 18, cd: 2.4, range: 520, radius: 96,  dur: 4.5, price: 72 },
      { dps: 29, cd: 2.2, range: 560, radius: 112, dur: 5.0, price: 125 },
    ],
  ...
  drain: {
    ...
    tiers: [
      { dmg: 12, cd: 0.70, range: 250, heal: 0.30, price: 18 },
      { dmg: 16, cd: 0.80, range: 270, heal: 0.35, price: 42 },
      { dmg: 26, cd: 0.70, range: 290, heal: 0.40, price: 82 },
      { dmg: 42, cd: 0.60, range: 320, heal: 0.50, price: 145 },
    ],
  ...
  nova: {
    ...
    tiers: [
      { dmg: 24, cd: 3.2, radius: 130, price: 18 },
      { dmg: 31, cd: 3.0, radius: 146, price: 44 },
      { dmg: 52, cd: 2.6, radius: 165, price: 88 },
      { dmg: 84, cd: 2.3, radius: 190, price: 155 },
    ],
  ...
  firebreath: {
    ...
    tiers: [
      ...
      { dmg: 24, cd: 1.30, range: 194, price: 46 },
      { dmg: 38, cd: 1.20, range: 207, price: 90 },
      { dmg: 60, cd: 0.84, range: 225, price: 160 },
    ],
  ...
  icebreath: {
    ...
    tiers: [
      { dmg: 12, cd: 1.70, range: 171, price: 20 },
      { dmg: 18, cd: 1.60, range: 185, price: 46 },
      { dmg: 29, cd: 1.45, range: 198, price: 90 },
      { dmg: 46, cd: 1.30, range: 216, price: 160 },
    ],
  ...
  earthbreath: {
    ...
    tiers: [
      { dmg: 15, cd: 1.20, range: 180, price: 20 },
      { dmg: 23, cd: 0.72, range: 194, price: 46 },
      { dmg: 36, cd: 1.02, range: 207, price: 90 },
      { dmg: 56, cd: 0.92, range: 225, price: 160 },
    ],
  ...
  windbreath: {
    ...
    tiers: [
      { dmg: 14, cd: 1.60, range: 180, price: 20 },
      { dmg: 21, cd: 1.20, range: 194, price: 46 },
      { dmg: 33, cd: 1.38, range: 207, price: 90 },
      { dmg: 52, cd: 1.25, range: 225, price: 160 },
    ],
