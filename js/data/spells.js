...
const SPELLS = {
  missile: {
    ...
    tiers: [
      { dmg: 25, cd: 0.80, range: 420, price: 14 },
      { dmg: 34, cd: 0.72, range: 450, price: 34 },
      { dmg: 48, cd: 0.64, range: 480, price: 68 },
      { dmg: 70, cd: 0.56, range: 520, price: 120 },
    ],
  ...
  lightning: {
    ...
    tiers: [
      { dmg: 7, cd: 1.15, range: 380, chains: 3, price: 20 },
      { dmg: 9, cd: 1.05, range: 400, chains: 4, price: 46 },
      { dmg: 12, cd: 0.95, range: 430, chains: 5, price: 90 },
      { dmg: 16, cd: 0.85, range: 460, chains: 7, price: 160 },
    ],
