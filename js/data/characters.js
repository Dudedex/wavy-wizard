...
const CHARACTERS = [
  {
    ...
    look: { robe: '#3a55c9', hat: '#2c3f9e', orb: '#7be1ff', hasHat: true, hasStaff: true },
  ...
  },
  {
    ...
    look: { robe: '#b8402e', hat: '#8a2b1d', orb: '#ffb347', hasHat: true, hasStaff: false },
    perks: ['+30% spell damage', '-15 max HP'],
    apply: s => { s.dmgMult += 0.30; s.maxHp -= 15; },
  },
  {
    id: 'cleric', name: 'Benedict', title: 'the Cleric',
    look: { robe: '#c9c2a8', hat: '#a89e7d', orb: '#ffe96b', hasHat: false, hood: true, hasStaff: true },
  ...
  },
  {
    ...
    look: { robe: '#5a2d7a', hat: '#3d1d54', orb: '#9be05a', hasHat: true, hasStaff: false, horn: true },
  ...
  },
  {
    ...
    look: { robe: '#1d7a72', hat: '#125049', orb: '#6be8ff', hasHat: false, hasStaff: true, hair: '#2a2a2a' },
  ...
  },
  {
    ...
    look: { robe: '#2f6f8f', hat: '#1d4a60', orb: '#aef0ff', hasHat: true, hasStaff: true },
    perks: ['-20% spell cooldowns', '-10% move speed'],
    apply: s => { s.cdMult *= 0.80; s.speedMult -= 0.10; },
  },
  {
    id: 'geomancer', name: 'Odo', title: 'the Geomancer',
    look: { robe: '#7a5a32', hat: '#5a3f1e', orb: '#d7b46a', hasHat: false, hasStaff: true, bald: true },
  ...
  },
  {
    ...
    look: { robe: '#3a3a6e', hat: '#26264a', orb: '#dfe7ff', hasHat: true, hasStaff: false, hair: '#caa6e0' },
  ...
  },
  {
    ...
    look: { robe: '#8a3a2a', hat: '#5a241a', orb: '#ff9a5a', hasHat: false, hasStaff: false, bald: true },
  ...
  },
  {
    ...
    look: { robe: '#6e2d7a', hat: '#46194f', orb: '#ff7be1', hasHat: true, hasStaff: false },
  ...
  },
  {
    ...
    look: { robe: '#2a3a6a', hat: '#1d2a4a', orb: '#aef0ff', hasHat: false, hood: true, hasStaff: true },
  ...
  // --- Drawback-driven wizards: each rebuilds the run around a weird constraint ---
  {
    ...
    look: { robe: '#3a7a4a', hat: '#235031', orb: '#ffe96b', hasHat: true, hasStaff: false },
  ...
  },
  {
    ...
    look: { robe: '#4a2d7a', hat: '#2f1d54', orb: '#b89aff', hasHat: false, hood: true, hasStaff: true },
  ...
  },
  {
    ...
    look: { robe: '#6a5a3a', hat: '#473c24', orb: '#d7c46a', hasHat: false, hood: true, hasStaff: true, bald: true },
    perks: ['Only 3 spell slots', '+60% spell damage'],
    apply: s => { s.maxSlots = 3; s.dmgMult += 0.60; },
  },
  {
    id: 'collector', name: 'Quill', title: 'the Collector',
    look: { robe: '#2d5a7a', hat: '#1d3d54', orb: '#8be0ff', hasHat: true, hasStaff: true },
  ...
  },
  {
    ...
    look: { robe: '#7a5aa8', hat: '#4a3070', orb: '#ff7be1', hasHat: true, hasStaff: true },
  ...
  },
  {
    ...
    look: { robe: '#7a2d3a', hat: '#541d28', orb: '#ff6b6b', hasHat: true, hasStaff: true, horn: true },
