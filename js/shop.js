...
function spellShopIcon(id) {
  ...
  switch (id) {
    ...
    case 'firebreath': return svg(`<path d="M10 42 Q31 8 58 16 Q46 34 58 52 Q31 56 10 42z" fill="#ff7a3a55" stroke="#ff7a3a" stroke-width="4"/><path d="M18 34h25c8 0 8-10 0-10M18 43h31c7 0 7 9-1 9M24 26h14" fill="none" stroke="#fff0ba" stroke-width="4" stroke-linecap="round"/><path d="M27 38c6-6 0-10 5-18 8 7 9 14 4 21 4-2 7-6 7-12 6 7 5 15-1 20-6 5-17 5-23-1 4 0 6-3 8-10z" fill="#ff8c42" opacity=".78"/>`);
